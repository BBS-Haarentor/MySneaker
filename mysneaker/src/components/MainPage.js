  ...
  return (
    <div className='flex justify-items-center items-center w-screen h-screen '>
        <div className='h-fit w-fit m-auto'>
          ...
          <a className='p-4 dark:shadow-gray-600 dark:shadow-md dark:bg-[#4fd1c5] dark:text-white shadow-lg rounded-3xl text-xl text-neutral-600 m-auto my-4 flex justify-around bg-white w-[90%]' href='/DashBoard'>DashBoard</a>
