...
import GameModal from "./Game2048/Modal/GameModal";
    ...
    return (
        <div className='flex  items-center w-screen h-screen relative' onDoubleClick={() => setGameActive(!gameActive)}>
            ...
            <div className='h-fit w-fit m-auto'>
                ...
                <div className='p-4 dark:shadow-gray-600 dark:shadow-md dark:bg-[#4fd1c5] dark:text-white shadow-lg rounded-3xl text-xl text-neutral-600 m-auto my-4 flex justify-around bg-white w-[90%]'
