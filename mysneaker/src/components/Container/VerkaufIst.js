...
const VerkaufIst = ({formatter, data}) => {
    ...
    return (
        <div
            className="max-[1899px]:w-full dark:bg-[#1f2733] dark:text-white p-4 shadow-lg rounded-3xl m-2 xl:col-span-3 bg-white flex justify-center snap-start ">
            <table>
                <tbody>
                <tr>
                    <th></th>
            ...
            <img alt="verkauf Ist Image" src="/img/data_reports.svg"
