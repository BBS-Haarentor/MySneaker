...
const Personal = ({PersonalRef, formatter, data, cycle, tempData, handleChange}) => {
    ...
    return (
        <div
            className="p-4 xl:col-span-3 shadow-lg rounded-3xl dark:bg-[#1f2733] dark:text-white m-2 bg-white flex justify-center snap-start"
            ref={PersonalRef}>
            <table>
                <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td><input className="border-2 border-[#4fd1c5] rounded-lg dark:bg-[#1f2733]" min="0"
                               name='new_employees' type="number" onChange={handleChange}
                               value={cycle.new_employees}></input> MA
                    </td>
                ...
                <tr>
                    ...
                    <td><input className="border-2 border-[#4fd1c5] rounded-lg dark:bg-[#1f2733]" min="0" type="number"
                               onChange={handleChange} value={cycle.let_go_employees}></input> MA
                    </td>
