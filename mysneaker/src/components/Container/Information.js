            ...
            <div className="w-full">
                ...
                <div
                    ...
                    <div
                        ...
                        <p className="text-center text-lg font-medium dark:text-white mb-5">{formatter.format((cycle.employees_count * (500 * (data.scenario.employee_cost_modfier)) + AllMaschienenKosten + (tempData.sneaker_cost + tempData.paint_cost)) + data.scenario.production_cost_per_sneaker1 * tempData.overall_production)}</p>
                        ...
                        <p className="text-center text-lg font-medium dark:text-white mb-5">{formatter.format((cycle.sales_planned * cycle.sales_bid) - ((cycle.employees_count * (500 * (data.scenario.employee_cost_modfier)) + AllMaschienenKosten + (tempData.sneaker_cost + tempData.paint_cost)) + data.scenario.production_cost_per_sneaker1 * tempData.overall_production))}</p>
                    ...
                    <div
                        ...
                        <p className="text-center text-xl font-bold my-5 dark:text-white">{formatter.format((cycle.employees_count * (500 * (data.scenario.employee_cost_modfier)) + AllMaschienenKosten + (tempData.sneaker_cost + tempData.paint_cost)) + data.scenario.production_cost_per_sneaker1 * tempData.overall_production)}</p>
                    </div>
                </div>
            </div>
        </>
