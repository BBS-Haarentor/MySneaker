                        ...
                        <div className={"block"}>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        className="block text-xl mb-3">Das Spiel ist jetzt in der nächsten Periode</span>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div className="hero container max-w-screen-lg mx-auto p-5">
                                        <svg className="mx-auto h-32 text-red-400" fill="currentColor"
            ...
            <div className='flex'>
                ...
                <div className='h-screen w-full overflow-hidden'>
                    ...
                    <div
                        ...
                        <div
                            className='inline-block dark:bg-[#1f2733] dark:border-[#282d3c] dark:text-white  shadow-lg rounded-3xl m-2 h-32 bg-white w-[160%] overflow-y-auto my-12'>
                            <ul>
                                {companies.map(({name, id, is_active}) => {
                                        if (is_active) {
                                            return (
                                                <li className='p-3 shadow-lg rounded-3xl m-auto my-4 flex justify-around dark:bg-[#28303c]  bg-white w-[90%]'
                                                    onClick={() => changeCompanie(name, id)}><p>{name}</p></li>
                                            )
                                        } else {
                                            return (<></>)
                                        }
                        ...
                        <div></div>
                        <button
                            className={'inline-block border-2 dark:bg-[#1f2733] dark:border-[#282d3c] dark:text-white  shadow-lg rounded-3xl m-2 h-32 bg-white w-[82%] my-12 '}
                            onClick={() => onClickRegister()}>
                            QR-Code anzeigen
                        </button>
                        <button
                            className='inline-block shadow-lg dark:bg-[#1f2733] dark:border-[#282d3c] dark:text-white  rounded-3xl m-2 h-32 bg-white w-[82%] my-12'
                            onClick={() => toggleTurnover()}>
                            Periode abschließen
                        </button>
                    </div>
                </div>
