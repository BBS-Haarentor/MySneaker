...
const SideNavBar = ({OnClick, state}) => {
        ...
        return <>
            <div id="drawer-example"
                 class={"fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 " + (infoToggle ? "" : "hidden")}
                 tabindex="-1" aria-labelledby="drawer-label">
                <h3 id="drawer-label"
                    class="inline-flex items-center mb-4 text-lg font-semibold text-gray-500 dark:text-gray-400">
                ...
                <p class="mb-6 text-md text-gray-500 dark:text-gray-400">{scenario.description}
                </p>
            </div>
                    ...
                    isLehe ? <><Spacer/> <NavBarButton text="LehrerPage" state={state}
                        ...
                        (token === undefined ?
                            <NavBarButton text="Login" state={state} onClick={OnClick}></NavBarButton> : <>
                                ...
                                <p className='mx-12 py-2 px-2 text-[#a0aec0] inline-block'>Scenario: <span id='scenario'/>
