...
class Scenario(ScenarioBase, table=True):
    ...
    machine_purchase_cost1: float = Field(default=12_000.00)
    machine_purchase_cost2: float = Field(default=25_000.00)
    machine_purchase_cost3: float = Field(default=45_000.00)
    sneaker_ask: int = Field(default=400)
    factor_ad_take: float = Field(default=0.1)
    tender_offer_count: int = Field(default=0)
    machine_production_capacity1: int = Field(default=200)
    machine_production_capacity2: int = Field(default=500)
    machine_production_capacity3: int = Field(default=1_000)
    machine_employee_max: int = Field(default=10)
    machine_maintainance_cost1: float = Field(default=4_000.00)
    machine_maintainance_cost2: float = Field(default=6_000.00)
    machine_maintainance_cost3: float = Field(default=8_000.00)
